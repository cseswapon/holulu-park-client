    ...
    return (
        <div className="container w-50 my-5">
            ...
            <form onSubmit={handelFrom}>
                <div className="mb-3">
                    <label htmlFor="exampleInputName" className="form-label"><i className="fas fa-user text-primary"></i> Name</label>
                ...
                <div className="mb-3">
                    <label htmlFor="exampleInputEmail1" className="form-label"><i className="fas fa-envelope text-center text-primary"></i> Email address</label>
            ...
            <div className="text-center">
                <button onClick={singinGoogle} className="btn btn-primary m-2"><i className="fab fa-google-plus text-light"></i></button>
