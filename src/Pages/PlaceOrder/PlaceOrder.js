...
const PlaceOrder = () => {
  useEffect(() => {
    document.title = "Holulu Theme Park-Order Place";
  }, []);
  const { user } = useAuth();
  const { id } = useParams();
  // console.log(id);
    ...
    <div className="container">
      <div className="text-center my-3">
        <small className="text-danger">
          Place Order Id : <strong>{id}</strong>
        </small>
      </div>
      <div className="row my-3 p-4">
        <div className="col-md-8 col-12">
          ...
          <hr />
          <div
            className="card my-3 mx-auto border-0"
          ...
          >
            <div className="border-0 g-0 align-items-center g-0 p-2 rounded-3 row">
              <div className="col-md-4">
                <img
                  src={img}
                  className="img-fluid rounded-circle rounded-top"
                  alt="not-found"
                />
              </div>
              <div className="col-md-8">
                <div className="card-body m-0 pt-0">
                  <h3 className="card-title text-muted">{name}</h3>
                  <hr />
                  <p className="card-text text-start text-muted">{info}</p>
                  <hr />
        ...
        <div
          ...
          className="col-md-4 col-12 place-order text-center"
        >
          <h1 className="text-center text-primary fw-bold">Place Order</h1>
          <hr />
